...
const YarnQualityModal = () => {
	...
	const handleSubmit = formData => {
		...
		formValues.category = formValues?.category?.length
			? formValues?.category
			: null;
		formValues.luster = formValues?.luster?.length ? formValues?.luster : null;
		formValues.process = formValues?.process?.length
			? formValues?.process
			: null;
		formValues.dye_type = formValues?.dye_type?.length
			? formValues?.dye_type
			: null;
		formValues.twist_type = formValues?.twist_type?.length
			? formValues?.twist_type
			: null;
		formValues.base_direction = formValues?.base_direction?.length
			? formValues?.base_direction
			: null;
		formValues.primary_td = formValues?.primary_td?.length
			? formValues?.primary_td
			: null;
		formValues.secondary_td = formValues?.secondary_td?.length
			? formValues?.secondary_td
			: null;
